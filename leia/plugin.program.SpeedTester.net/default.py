...
def OOoo(list=False, mini=None, server=None, share=False, simple=False, src=None, timeout=10, units=('bit', 8),
    ...
    oo0[0] = 'Recuperando os Parametros speedtest.net...'
    iIIiiiI.update(10, oo0[0], oo0[1], oo0[2])
    if not simple:
        Ii11iI1i('Recuperando os Parametros speedtest.net...')
    try:
        OooooOOoo0 = O0Oo0oOOoooOOOOo()
    except URLError:
        iIIiiiI.close()
        Ii11iI1i('Erro ao Recuperar os Parametros')
        sys.exit(1)
        if 44 - 44: oooO0oo0oOOOO
    oo0[1] = 'Recuperando Lista Servidores speedtest.net...'
    iIIiiiI.update(15, oo0[0], oo0[1], oo0[2])
    if not simple:
        Ii11iI1i('Recuperando Lista Servidores speedtest.net...')
    if list or server:
    ...
    oo0[2] = 'Sua Operadora: %(isp)s (%(ip)s)...' % OooooOOoo0['client']
    iIIiiiI.update(25, oo0[0], oo0[1], oo0[2])
    if not simple:
        Ii11iI1i('Sua Operadora: %(isp)s (%(ip)s)...' % OooooOOoo0['client'])
        if 46 - 46: Oo0Ooo
    if server:
        try:
    ...
    oo0[0] = oo0[1]
    oo0[1] = oo0[2]
    oo0[2] = 'Testando sua Velocidade de Download...'
    iIIiiiI.update(50, oo0[0], oo0[1], oo0[2])
    if not simple:
        Ii11iI1i('Testando sua Velocidade de Download', end='')
    ...
    oo0[0] = oo0[1]
    oo0[1] = oo0[2]
    oo0[2] = 'Testando sua Velocidade de Upload...'
    iIIiiiI.update(80, oo0[0], oo0[1], oo0[2])
    if not simple:
        Ii11iI1i('Testando sua Velocidade de Upload', end='')
    ...
    if share and mini:
        ...
        if OoOo0o is False:
            Ii11iI1i('Erro ao Obter os Parametros em speedtest.net')
            sys.exit(1)
...
class oO(xbmcgui.Window):
    ...
    def buildElements(self):
        ...
        self.please_wait_textbox = xbmcgui.ControlLabel(iiI11, OOoO000, oOo00O000Oo0, I1iI1I1I1i11i,
                                                        label='Por favor, Espere...', textColor='0xFFFFFFFF', alignment=2 | 4)
        ...
        self.button_run = xbmcgui.ControlButton(iiIIIiIi1IIi, ii11i, oooO0, iiIIiii, "[B]Iniciar[/B]",
        ...
        self.button_close = xbmcgui.ControlButton(iiI11, OOoO000, oOo00O000Oo0, I1iI1I1I1i11i, "[B]Fechar[/B]",
                                                  focusTexture=self.image_button_run,
                                                  noFocusTexture=self.image_button_run, alignment=2 | 4,
                                                  textColor='0xFF000000', focusedColor='0xFF000000',
    ...
    def speedtest(self, list=False, mini=None, server=None, share=False, simple=False, src=None, timeout=10,
        ...
        oo0.append('Recuperando os Parametros speedtest.net...')
        ...
        oo0.append('Recuperando Lista Servidores speedtest.net...')
        self.update_textbox(oo0)
        ...
        oo0.append('Sua Operadora: %(isp)s (%(ip)s)...' % OooooOOoo0['client'])
        self.update_textbox(oo0)
        ...
        oo0.append('Testando sua Velocidade de Download...')
        self.update_textbox(oo0)
        if not simple:
            Ii11iI1i('Testando sua Velocidade de Download', end='')
        ...
        oo0.append('Testando sua Velocidade de Upload...')
        self.update_textbox(oo0)
        if not simple:
            Ii11iI1i('Testando sua Velocidade de Upload', end='')
        ...
        if share and mini:
            ...
            oOOo00O0OOOo.close()
            oo0.append('Resultados Salvos: %s' % self.image_result)
            self.update_textbox(oo0)
...
class oO0ooOO(xbmcgui.WindowXMLDialog):
    ...
    def displayButtonClose(self, function="true"):
        if (function == "true"):
            ...
            self.button_close = xbmcgui.ControlButton(99999, 99999, o0o0oOO, i1IiI, "[B]Fechar[/B]",
                                                      focusTexture=self.image_button_run,
                                                      noFocusTexture=self.image_button_run, alignment=2 | 4,
                                                      textColor='0xFF000000', focusedColor='0xFF000000',
                                                      shadowColor='0xFFCCCCCC')
    ...
    def displayProgressBar(self, function="true"):
        if (function == "true"):
            ...
            OOoO000 = (self.screeny / 3) - (I1iI1I1I1i11i / 2) + 270
            self.please_wait_textbox = xbmcgui.ControlLabel(iiI11, OOoO000, oOo00O000Oo0, I1iI1I1I1i11i,
                                                            label='Por favor, Espere...', textColor='0xFFFFFFFF',
                                                            alignment=2 | 4)
            self.addControl(self.please_wait_textbox)
        elif (function == "visible"):
